...
import { processCommand } from '@/features/terminal/lib/terminal-parser';
import { formatDate, generateId } from '@/shared/lib/utils';
import type { CommandHistory, TerminalState } from '@/features/terminal/types/terminal';
