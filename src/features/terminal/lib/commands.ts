...
import { asciiConfig } from '@/features/terminal/config/ascii';
import { certificationsConfig } from '@/shared/config/certifications';
import { AVAILABLE_COMMANDS } from '@/features/terminal/config/commands';
import { contactConfig } from '@/shared/config/contact';
import { educationConfig } from '@/shared/config/education';
import { experienceConfig } from '@/shared/config/experience';
import { projectsConfig } from '@/shared/config/projects';
import { skillsConfig } from '@/shared/config/skills';
